...
GRIND_ALGO = {
    ...
    "ALGO_MIN_DAILY_PICKS": config("ALGO_MIN_DAILY_PICKS", default="6"),
    "ALGO_MAX_DAILY_DC12_PICKS": config("ALGO_MAX_DAILY_DC12_PICKS", default="1"),
    "ALGO_MAX_DAILY_SAME_MARKET_PICKS": config("ALGO_MAX_DAILY_SAME_MARKET_PICKS", default="2"),
