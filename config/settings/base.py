...
GRIND_ALGO = {
    "ALGO_API_FOOTBALL_CONTEXT_ENABLED": config("ALGO_API_FOOTBALL_CONTEXT_ENABLED", default="False"),
    "ALGO_API_FOOTBALL_CONTEXT_RECENT_FIXTURES": config("ALGO_API_FOOTBALL_CONTEXT_RECENT_FIXTURES", default="5"),
    "ALGO_API_FOOTBALL_CONTEXT_FIXTURE_STATS_ENABLED": config("ALGO_API_FOOTBALL_CONTEXT_FIXTURE_STATS_ENABLED", default="False"),
