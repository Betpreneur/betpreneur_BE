...
from betpreneur.modules.identity.events import UserEmailVerified
from betpreneur.modules.identity.models import User
from betpreneur.modules.identity.services import notifications
from betpreneur.modules.identity.services.verification import (
    run_verification_contributors,
)
from betpreneur.platform.events import bus
...
class VerifyEmailView(APIView):
    ...
    def post(self, request):
        ...
        if (
            ...
            extras = run_verification_contributors(user)
            bus.publish(UserEmailVerified(user_id=user.id, email=user.email))
