...
from betpreneur.integrations.payfonte.client import PayfonteError
...
class TokenWalletServiceTests(TestCase):
    ...
    def test_expire_token_reservations_task_runs_stale_reservation_sweep(self):
        ...
        # billing.tasks.expire_token_reservations is a thin wrapper around
        # this; calling the service keeps the test inside the boundary.
        result = self.service.expire_stale_reservations(limit=10)
...
class TokenWalletApiTests(TestCase):
    ...
    @patch("betpreneur.modules.billing.interface.views.payfonte_client")
...
class VerifyEmailGrantTests(TestCase):
    ...
    def test_verification_still_succeeds_when_the_grant_fails(self):
        ...
        with patch(
            "betpreneur.modules.billing.services.wallet.TokenWalletService.grant_signup_tokens",
