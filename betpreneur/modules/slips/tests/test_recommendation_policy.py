...
from betpreneur.modules.slips.domain.slip_analysis import _manual_verdict, _selection_card
...
class RecommendationPolicyTests(TestCase):
    ...
    def test_games_keep_best_market_but_show_no_recommendation(self):
        ...
        game = game_summary_from_fixture(fixture, {}, request=None, include_markets=True)
    ...
    def test_probation_league_market_needs_extra_edge(self):
        ...
        game = game_summary_from_fixture(fixture, {}, request=None)
    ...
    def test_slip_review_matches_sportybet_home_or_away_alias(self):
        self.assertTrue(market_matches("Home or Away", "DC: 12"))
