...
class StatPalSnapshotApiTests(TestCase):
    ...
    def test_fixture_context_can_refresh_without_forcing(self):
        self.client.force_authenticate(self.user)
        with patch("betpreneur.modules.catalog.interface.views.statpal_snapshot_service.refresh_fixture_snapshots") as refresh:
            with patch("betpreneur.modules.catalog.interface.views.statpal_snapshot_service.fixture_context") as context:
