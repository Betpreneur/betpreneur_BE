...
from apps.algo.scoring.evaluators.registry import SCORE_MATRIX_ENGINE, evaluator_for, required_capabilities
...
def capability_for_descriptor(descriptor, *, fixture=None, statpal_context=None):
    ...
    """
    from apps.algo.scoring.evaluators.registry import COUNT_MODEL_ENGINE, evaluator_for
    from apps.algo.markets.api import market_capability_service
    ...
    if spec.engine == COUNT_MODEL_ENGINE:
        from apps.algo.scoring.rate_profiles import team_rate_profile_service
