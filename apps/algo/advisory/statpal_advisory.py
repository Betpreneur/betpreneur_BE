...
from ..scoring.api import (
    ...
    SCORE_MATRIX_ENGINE,
    build_score_matrix,
    evaluate as evaluate_scored_market,
    evaluator_for,
    lineup_service,
    outcome_probability,
    player_availability_service,
)
from ..markets.api import MarketDescriptor, describe_market, normalize_market_text
...
class StatPalMarketAdvisoryService:
    ...
    def evaluate_market(
        ...
        *,
        ...
        if spec.engine in {SCORE_MATRIX_ENGINE, COUNT_MODEL_ENGINE}:
            payload = evaluate_scored_market(descriptor, fixture=fixture)
    ...
    # distribution (apps.algo.scoring.evaluators.score_matrix_evaluator, ADR-001).
