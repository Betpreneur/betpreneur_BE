...
from apps.algo.picks.daily_market_catalog import (
...
from apps.algo.scoring.api import QUANTITATIVE
...
def fetch_aps_fixtures(target_date):
    ...
    for f in aps_all:
        ...
        fixtures.append({
            ...
            "country_flag": f.get("league", {}).get("flag", ""),
...
MARKET_THRESHOLDS = {
    ...
    "DC: 12":70,"DNB Home":64,"DNB Away":85,
    ...
    for fx,confs,real_odds in zip(scored_fxs,all_confs,odds_list):
        for market,conf in confs.items():
            ...
            candidate = {
                ...
                "league_logo":fx.get("league_logo",""),
                "country":fx.get("country",""),
                "country_flag":fx.get("country_flag",""),
                "round":fx.get("round",""),
    ...
    for tier, selected in (
        ...
        for pick in selected:
            picks.append({
                ...
                "league": pick.get("league", ""),
                "league_logo": pick.get("league_logo", ""),
                "country": pick.get("country", ""),
                "country_flag": pick.get("country_flag", ""),
