...
from apps.algo.models import PlayerAvailability
from apps.algo.scoring.availability import (
    name_keys,
    normalize_person,
...
class AvailabilityServiceTests(TestCase):
    ...
    def test_a_failed_lookup_does_not_block_pricing(self):
        ...
        with mock.patch(
            "apps.algo.models.PlayerAvailability.objects", side_effect=RuntimeError("db down")
        ):
