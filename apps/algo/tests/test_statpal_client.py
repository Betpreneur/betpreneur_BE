...
from apps.algo.statpal import StatPalClient, StatPalConfig, StatPalConfigurationError
...
class StatPalClientTests(SimpleTestCase):
    ...
    def test_configured_endpoint_override(self):
        session = DummySession()
        client = StatPalClient(session=session)
    ...
    def test_documented_soccer_endpoint_helpers(self):
        ...
        self.assertEqual(session.calls[1]["url"], "https://statpal.io/api/v2/soccer/matches/daily")
        self.assertEqual(session.calls[1]["params"]["date"], "2026-08-07")
        self.assertEqual(session.calls[2]["url"], "https://statpal.io/api/v2/soccer/leagues/39/matches")
        self.assertEqual(session.calls[3]["url"], "https://statpal.io/api/v2/soccer/predictions")
        self.assertEqual(session.calls[4]["url"], "https://statpal.io/api/v2/soccer/leagues/39/odds/prematch")
