...
class StatPalClientTests(SimpleTestCase):
    ...
    def test_documented_soccer_endpoint_helpers(self):
        ...
        self.assertEqual(session.calls[11]["url"], "https://statpal.io/api/v2/soccer/team-lineups")
        self.assertEqual(session.calls[11]["params"]["match_id"], "2026061822389")
        self.assertEqual(session.calls[12]["url"], "https://statpal.io/api/v2/soccer/predictions")
        self.assertEqual(session.calls[13]["url"], "https://statpal.io/api/v2/soccer/leagues/39/odds/prematch")
