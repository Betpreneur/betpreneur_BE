...
class UnanalysedStatusTests(TestCase):
    def test_missing_score_is_unknown_not_avoid(self):
        self.assertEqual(_match_checker_status(None), "unknown")

    def test_a_genuine_zero_score_is_still_avoid(self):
        self.assertEqual(_match_checker_status(0), "avoid")
        self.assertEqual(_match_checker_status(54), "avoid")
