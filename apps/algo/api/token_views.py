"""Token wallet and payment API views."""
...
from apps.algo.models import TokenPurchase, TokenTransaction
...
from apps.algo.wallet.api import (
    PayfonteError,
...
def _token_wallet_payload(user):
    ...
    return {
        "wallet": token_wallet_snapshot(wallet),
    }
...
class TokenWalletView(APIView):
    ...
    @extend_schema(
        ...
        description="Authenticated user endpoint. Returns the current user's free and paid token balances.",
        tags=["Tokens"],
