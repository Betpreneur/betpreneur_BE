...
from .picks.api import algo_runner_service, assess_recommendation
from .slip_review import api as slip_review_redis
from .slip_review.api import (
    ...
    consume_slip_review_token_reservation as _consume_slip_review_token_reservation,
    create_analysing_slip_review as _create_analysing_slip_review,
    create_failed_slip_review as _create_failed_slip_review,
    create_queued_slip_review as _create_queued_slip_review,
    descriptor_from_taxonomy as _descriptor_from_taxonomy,
    empty_api_usage as _empty_api_usage,
    empty_slip_summary as _empty_slip_summary,
    insufficient_feature_tokens_payload as _insufficient_feature_tokens_payload,
    insufficient_tokens_payload as _insufficient_tokens_payload,
    active_slip_review_public_payload as _active_slip_review_public_payload_impl,
    compact_ai_pick_from_selection as _compact_ai_pick_from_selection_impl,
    compact_slip_review_list_payload as _compact_slip_review_list_payload_impl,
    consume_review_force_fresh as _consume_review_force_fresh,
    has_statpal_hydration_identity as _has_statpal_hydration_identity,
    initialize_slip_selection_progress_rows as _initialize_slip_selection_progress_rows_impl,
    leg_results_from_persisted_slip_selections as _leg_results_from_persisted_slip_selections,
    mark_slip_review_completed as _mark_slip_review_completed,
    mark_slip_review_failed as _mark_slip_review_failed,
    market_can_skip_core_on_demand as _market_can_skip_core_on_demand,
    mark_slip_selection_analysing as _mark_slip_selection_analysing,
    optimized_leg_score as _optimized_leg_score,
    persist_slip_selection_progress_result as _persist_slip_selection_progress_result_impl,
    replace_slip_selection_analysis_rows as _replace_slip_selection_analysis_rows,
    provider_kickoff_datetime as _provider_kickoff_datetime,
    ...
    leg_state_counts as _leg_state_counts_impl,
    plural as _plural,
    price_reason_code as _price_reason_code,
    public_action_label as _public_action_label,
    public_confidence_label as _public_confidence_label,
    public_market_meaning as _public_market_meaning_impl,
    public_market_pick as _public_market_pick_impl,
    public_price_check_from_card as _public_price_check_from_card,
    public_recommendation_strength as _public_recommendation_strength,
    public_risk_label as _public_risk_label,
    public_selection_risk as _public_selection_risk,
    ...
    public_ticket_killers as _public_ticket_killers,
    public_verdict_message as _public_verdict_message,
    public_verdict_object as _public_verdict_object,
    public_why_from_card as _public_why_from_card,
    ...
    release_slip_review_token_reservation as _release_slip_review_token_reservation,
    reserve_slip_review_tokens as _reserve_slip_review_tokens,
    resolved_canonical_market as _resolved_canonical_market,
    resolved_taxonomy as _resolved_taxonomy,
    risk_level_for,
    selection_expiry as _selection_expiry,
    selection_market_descriptor as _selection_market_descriptor,
    selection_card as _selection_card_impl,
    selection_has_analysis as _selection_has_analysis,
    selection_is_unmatched as _selection_is_unmatched,
    selection_original_odds as _selection_original_odds,
    selection_strength_score as _selection_strength_score,
    selection_suggested_odds as _selection_suggested_odds,
    ...
    get_or_lock_slip_leg_analysis_cache as _get_or_lock_slip_leg_analysis_cache_impl,
    mark_slip_leg_analysis_cache_failed as _mark_slip_leg_analysis_cache_failed_impl,
    set_slip_review_progress as _set_slip_review_progress,
    slip_recap_payload as _slip_recap_payload,
    slip_leg_analysis_cache_key as _slip_leg_analysis_cache_key,
    slip_review_leg_failure_result as _slip_review_leg_failure_result,
    slip_review_payload as _slip_review_payload_impl,
    slip_review_billable_selection_count as _slip_review_billable_selection_count,
    ...
    smart_randomize_candidates as _smart_randomize_candidates,
    smart_randomize_option_values as _smart_randomize_option_values,
    smart_randomize_pick_for_game as _smart_randomize_pick_for_game,
    smart_randomize_ranking_score as _smart_randomize_ranking_score,
    smart_randomize_summary as _smart_randomize_summary,
    smart_randomize_ticket as _smart_randomize_ticket,
    ...
    ticket_health_label as _ticket_health_label,
    ticket_health_summary as _ticket_health_summary,
    ticket_issue_text as _ticket_issue_text,
    ticket_risk_level_from_score as _ticket_risk_level_from_score,
    with_bettor_view as _with_bettor_view,
    with_explanation as _with_explanation_impl,
    with_smart_randomize as _with_smart_randomize,
    with_leg_risk as _with_leg_risk,
    ticket_risk_service,
...
from .advisory.api import assess_leg, statpal_market_advisory
from .market_data.api import statpal_snapshot_service
from .settlement.api import (
    add_pick,
    confidence_band,
    empty_stats,
    finalize_stats,
...
from .tasks import import_slip_review
...
from .api.response_utils import (
    api_response_payload as _api_response_payload,
    json_safe as _json_safe,
)
from .api.maintenance import maintenance_jobs as _maintenance_jobs
...
def _fresh_recent_forms_for_pick(pick, fixture_summary=None):
    ...
    if (needs_home or needs_away) and pick.match_id:
        try:
            from .picks.grindalgo.algo_runner import (
                aps_get,
...
_public_market_meaning = partial(
    _public_market_meaning_impl,
    describe_market=describe_market,
    market_matches=_market_matches,
    market_options=SLIP_REVIEW_MARKET_OPTIONS,
)
_public_market_pick = partial(
    _public_market_pick_impl,
    describe_market=describe_market,
    market_matches=_market_matches,
    market_options=SLIP_REVIEW_MARKET_OPTIONS,
    match_checker_status=_match_checker_status,
)
_with_explanation = partial(_with_explanation_impl, explain_leg=explanation_service.explain_leg)
_leg_state_counts = partial(_leg_state_counts_impl, assess_leg=assess_leg)
...
def _fixture_wide_market_candidates(selected_descriptor, *, game=None, statpal_context=None):
    ...
    include_fixture_wide_pool = _market_family_group(selected_market) not in SPECIALIST_REPLACEMENT_GROUPS
...
def _fit_from_line(expected, line, side, *, scale):
    expected = _float_or_none(expected)
    line = _float_or_none(line)
...
def _fit_from_probability(probability, *, neutral=50):
    probability = _float_or_none(probability)
    if probability is None:
        return None
...
def _result_fit_from_payload(payload, side):
    ...
    if side == "home_or_draw":
        ...
        draw = _float_or_none(payload.get("draw_probability"))
...
def _replacement_ranking_score(market, *, selected_market=None):
    ...
    if probability is None:
        probability = _float_or_none(market.get("display_score")) or 0
    fit = _market_profile_fit_score(market)
    edge = _market_edge(market)
    ev = _float_or_none(market.get("ev"))
    if ev is None:
        ev = _market_expected_value(market)
    similarity = _market_similarity_score(selected_market, market) if selected_market else 0
...
def _select_ranked_replacement(allowed, *, selected_market):
    ranked = sorted(
        ...
        key=lambda market: (
            ...
            _float_or_none(market.get("advisory_score")) or 0,
        ),
        reverse=True,
    )
...
def _replacement_candidate_is_eligible(market):
    ...
    probability = _float_or_none(market.get("advisory_score"))
    if probability is None:
        probability = _float_or_none(market.get("display_score"))
...
def _replacement_is_supported_fit(selected_market, replacement_market):
    ...
    if not _market_was_assessed(replacement_market):
        return False
    replacement_score = _float_or_none(replacement_market.get("advisory_score"))
    ...
    *,
    ...
    if selected_market:
        ...
        if not allowed:
            supported = []
            for market in candidates:
                scope = market.get("replacement_scope") or _replacement_scope(selected_market, market)
                if scope == "broad_fallback" and conflict_blocks_broad:
                    continue
                if scope == "broad_fallback" and (not allow_safer_fallback or not _allows_broad_replacement(selected_market)):
                    continue
...
_selection_card = partial(
    _selection_card_impl,
    alternative_reason=_match_checker_alternative_reason,
...
def _result_model_line_from_evidence(evidence):
    ...
    statpal = evidence.get("statpal") if isinstance(evidence.get("statpal"), dict) else {}
    for payload in (evidence, statpal):
        home = _float_or_none(payload.get("home_win_probability") or payload.get("home_probability"))
        draw = _float_or_none(payload.get("draw_probability"))
        away = _float_or_none(payload.get("away_win_probability") or payload.get("away_probability"))
...
def _market_owned_model_lines(market_payload, evidence):
    market_payload = market_payload or {}
    ...
    group = _market_family_group({"market": market_name, "market_taxonomy": taxonomy})
    lines = []
    ...
    if group == "goals":
        if family in {"btts", "total_btts", "result_btts"}:
            ...
            if line:
                lines.append(line)
        goal_line = _goal_model_line_from_evidence(evidence)
        if goal_line:
    ...
    if period == "first_half":
        period_line = _period_or_family_line({}, market_payload)
        if period_line:
...
def _stats_backed_evidence(selection, *, market_payload=None, include_context=True, owned_market_only=False):
    ...
    if owned_market_only:
        evidence.extend(_market_owned_model_lines(market_payload, selected_evidence))
    else:
        for label, form in (
...
def _bettor_recommendation(selection):
    ...
    why = _stats_backed_evidence(
        ...
        owned_market_only=(
            ...
            and not _market_matches(user_pick.get("market"), effective_ai_pick.get("market"))
        ),
    )
...
def _populate_slip_review(review, results):
    ...
    _replace_slip_selection_analysis_rows(
        review,
        safe_results,
        defaults_builder=_slip_selection_defaults_from_analysis,
    )
    return summary, safe_results


def _slip_selection_defaults_from_analysis(item):
    return _slip_selection_defaults_from_analysis_impl(
        item,
        settlement_market_for=_settlement_market_for,
        decimal_or_none=_decimal_or_none,
    )


def _initialize_slip_selection_progress_rows(review, selections):
    return _initialize_slip_selection_progress_rows_impl(
        review,
        selections,
        defaults_builder=_slip_selection_defaults_from_analysis,
    )
...
def _persist_slip_selection_progress_result(review, index, result):
    return _persist_slip_selection_progress_result_impl(
        review,
        index,
        result,
        defaults_builder=_slip_selection_defaults_from_analysis,
...
def _create_slip_review(user, *, source, submitted_payload, results):
    review = _create_analysing_slip_review(
        user,
        source=source,
...
def _active_slip_review_public_payload(review, *, summary, progress, latest_event_id):
    return _active_slip_review_public_payload_impl(
        review,
        summary=summary,
        progress=progress,
        latest_event_id=latest_event_id,
        selection_has_analysis=_selection_has_analysis,
        manual_review_summary=_manual_review_summary,
        build_bettor_public_payload=_build_bettor_public_payload,
        with_smart_randomize=_with_smart_randomize,
    )


def _compact_ai_pick_from_selection(selection):
    return _compact_ai_pick_from_selection_impl(selection, public_score=_public_score)


def _compact_slip_review_list_payload(review, *, include_picks=True, pick_limit=None, use_summary=True):
    return _compact_slip_review_list_payload_impl(
        review,
        include_picks=include_picks,
        pick_limit=pick_limit,
        use_summary=use_summary,
        build_bettor_public_payload=_build_bettor_public_payload,
        public_score=_public_score,
    )


def _slip_review_payload(review, *, include_selections=True, public_only=False):
    return _slip_review_payload_impl(
        review,
        include_selections=include_selections,
        public_only=public_only,
        api_response_payload=_api_response_payload,
        build_bettor_public_payload=_build_bettor_public_payload,
        with_smart_randomize=_with_smart_randomize,
        selection_has_analysis=_selection_has_analysis,
        manual_review_summary=_manual_review_summary,
...
def _get_or_lock_slip_leg_analysis_cache(selection):
    return _get_or_lock_slip_leg_analysis_cache_impl(selection)


def _store_slip_leg_analysis_cache(selection, result, *, cache_key=None, raw_key=None):
    return _store_slip_leg_analysis_cache_impl(
        selection,
        result,
        cache_key=cache_key,
        raw_key=raw_key,
...
def _mark_slip_leg_analysis_cache_failed(selection, *, cache_key=None):
    return _mark_slip_leg_analysis_cache_failed_impl(
        selection,
        cache_key=cache_key,
    )
...
def process_slip_review_leg_analysis(review_id, index, selection, *, days=3):
    review = SlipReview.objects.get(id=review_id)
    _mark_slip_selection_analysing(review, index, selection)
    total = review.selections.count()
    _publish_slip_review_event(
        review,
        "leg.started",
...
def finalize_slip_review_import_results(review_id, leg_results):
    ...
    _mark_slip_review_completed(review, summary, submitted_payload=final_payload, total=len(results))
    log.info(
...
def process_slip_review_import(review_id):
    ...
    try:
        ...
        _mark_slip_review_failed(review, public_error, error_code="failed")
        raise
...
def fail_slip_review_import(review_id, message, *, error_code="failed", error_payload=None, release_tokens=True):
    ...
    if release_tokens:
        _release_slip_review_token_reservation(review)
    _mark_slip_review_failed(review, message, error_code=error_code, error_payload=error_payload)
    return _api_response_payload(
        {
            "review_id": review.id,
            "status": _public_slip_review_status(review.status),
